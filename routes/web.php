...
Route::get('/download-pdf/{id}','PDFController@mirspdf')->name('mirs-download');
Route::post('/download-mctsummary-print','PDFController@MCTsummaryprint')->name('mct-summary-print')->middleware('IsWarehouseAndAdmin');
...
Route::get('/MRT-create/{id}','MRTController@CreateMRT')->name('create.mrt')->middleware('IfAlreadyHaveMRT');
Route::get('/MRT-create-fetch-mct-or-mrt/{mctno}','MRTController@CreateMRTFetchMCTdata');
Route::post('/MRT-store/{MCTNo}','MRTController@StoreMRT')->name('storing.mrt')->middleware('IfAlreadyHaveMRT');
...
Route::get('mrt-print-summary','PDFController@mrtpdf')->name('mrt-summary-print')->middleware('IsWarehouseAndAdmin');
...
Route::get('/printRRpdf/{id}','PDFController@rrdownload')->name('RR-printing');
...
Route::get('/RVdownload/{id}','PDFController@RVdownload')->name('downloadRVprint');
...
Route::get('/po-download-print/{id}','PDFController@POdownload')->name('downloadPO');
...
Route::get('/mr-print/{id}','PDFController@MRprinting')->name('printMR');

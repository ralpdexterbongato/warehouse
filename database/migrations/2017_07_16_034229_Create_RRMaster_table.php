...
class CreateRRMasterTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('RRMaster', function (Blueprint $table)
        {
            ...
            $table->string('RRNo',7);
            $table->date('RRDate');
            $table->string('Suplier',50)->nullable();
            $table->string('Address',100)->nullable();
            $table->char('InvoiceNo',10)->nullable();
            $table->char('RVNo',9)->nullable();
            $table->char('BNo',9)->nullable();
            $table->string('Carrier',30)->nullable();
            $table->char('DeliveryReceiptNo',9)->nullable();
            $table->char('PONo',9)->nullable();

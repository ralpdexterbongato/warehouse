...
class CreateIndexTestInnodbTable extends Migration
{
    /**
     * Schema table name to migrate
     * @var string
     */
    public $set_schema_table = 'index_test_innodb';

    /**
     * Run the migrations.
     * @table index_test_innodb
     *
     * @return void
     */
    public function up()
    {
        ...
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            ...
            $table->index(["combined_index_column_1", "combined_index_column_2"], 'combined_index_INDEX');

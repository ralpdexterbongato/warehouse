...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" I can't\r\n        ")])], 1) : _vm._e(), _vm._v(" "), ((((_vm.MRMaster.RecommendedbySignature == null) && (_vm.MRMaster.Recommendedby == _vm.user.Fname + ' ' + _vm.user.Lname) && (_vm.MRMaster.IfDeclined == null)) || ((_vm.MRMaster.GeneralManagerSignature == null) && (_vm.MRMaster.GeneralManager == _vm.user.Fname + ' ' + _vm.user.Lname) && (_vm.MRMaster.RecommendedbySignature != null) && (_vm.MRMaster.IfDeclined == null)) || ((_vm.MRMaster.ReceivedbySignature == null) && (_vm.MRMaster.ReceivedbySignature == null) && (_vm.MRMaster.Receivedby == _vm.user.Fname + ' ' + _vm.user.Lname) && (_vm.MRMaster.IfDeclined == null) && ((_vm.MRMaster.GeneralManagerSignature != null) || (_vm.MRMaster.ApprovalReplacerSignature != null))))) ? _c('span', [_c('longpress', {
    staticClass: "rvapprovebtn",
    attrs: {
      "id": "signatureMRbtn",
      "duration": "3",

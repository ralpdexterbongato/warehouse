...
Vue.component('history', __webpack_require__(237));
Vue.component('loginpage', __webpack_require__(246));
Vue.component('managers', __webpack_require__(235));
Vue.component('myaccount', __webpack_require__(236));
new Vue({
    el: '#accounts'
});

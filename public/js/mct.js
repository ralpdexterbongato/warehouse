...
Vue.component('mctpreview', __webpack_require__(82));
Vue.component('mctindex', __webpack_require__(83));
new Vue({
  el: '#mct'
});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "click": function($event) {
        _vm.signatureMCT(), _vm.IsDisabled = true
      }
    }
  }, [_c('i', {
    ...
    on: {
      "click": function($event) {
        _vm.declineMCT(), _vm.IsDisabled = true
      }
    }
  }, [_c('i', {
    staticClass: "fa fa-times"
  }), _vm._v(" Decline")])])]) : _vm._e()]) : _vm._e()]), _vm._v(" "), _c('div', {

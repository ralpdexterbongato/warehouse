...
Vue.component('globalnotification', __webpack_require__(234));
new Vue({
   el: '#masterGN'
});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('li', {
    ...
    return _c('a', {
      attrs: {
        "href": [notification.FileType == 'MIRS' ? '/previewFullMIRS/' + notification.FileNo : notification.FileType == 'MCT' ? '/preview-mct-page-only/' + notification.FileNo : notification.FileType == 'MRT' ? '/mrt-preview-page/' + notification.FileNo : notification.FileType == 'RV' ? '/RVfullview/' + notification.FileNo : notification.FileType == 'RR' ? '/RR-fullpreview/' + notification.FileNo : notification.FileType == 'PO' ? '/po-full-preview/' + notification.FileNo : notification.FileType == 'MR' ? '/full-preview-MR/' + notification.FileNo : '']
      },
      on: {
        "click": function($event) {

...
<div class="managerbox-container">
  <div class="manager-box">
    ...
    <div class="manager-assigned-name">
      <h1 v-if="currentAssigned!=null">{{currentAssigned.Fname}} {{currentAssigned.Lname}}</h1>
    ...
    <div class="Manager-List">
      ...
      <select v-model="AssignedManagerID" v-if="editActive==true">
        ...
        <option v-for="manager in Managers" :value="manager.id">{{manager.Fname}} {{manager.Lname}}</option>
      </select>
      <span class="underline" v-if="editActive==false&&currentAssigned!=null">{{currentAssigned.Fname}} {{currentAssigned.Lname}}</span>

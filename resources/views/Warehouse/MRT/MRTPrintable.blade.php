        ...
        <div class="signaturer-name">
          <div class="signature-image">
            @if ($mrtMaster[0]->users[1]->pivot->Signature=='0')
              <img src="warehouseinventorycontrol.herokuapp.com/public/ForHerokuOnly/{{$mrtMaster[0]->users[1]->Signature}}" alt="signature">
            @endif
          </div>
        ...
        <div class="signaturer-name">
          <div class="signature-image">
            @if ($mrtMaster[0]->users[0]->pivot->Signature=='0')
              <img src="warehouseinventorycontrol.herokuapp.com/public/ForHerokuOnly/{{$mrtMaster[0]->users[0]->Signature}}" alt="signature">
            @endif
          </div>

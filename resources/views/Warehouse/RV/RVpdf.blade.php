        ...
        <div class="bottom-signatures-container">
          <div class="bottom-left-sign">
            ...
            <li>
              ...
              <h1><img src="warehouseinventorycontrol.herokuapp.com/public/ForHerokuOnly/{{$RVMaster[0]->users[0]->Signature}}" alt="signature"></h1>
              @endif
          ...
          <div class="bottom-right-sign">
            ...
            <li>
              @if ($RVMaster[0]->users[1]->pivot->Signature == '0')
                <h1><img src="warehouseinventorycontrol.herokuapp.com/public/ForHerokuOnly/{{$RVMaster[0]->users[1]->Signature}}" alt="signature"></h1>
              @elseif(isset($RVMaster[0]->users[4])&&($RVMaster[0]->users[4]->pivot->Signature=='0')&&($RVMaster[0]->users[4]->pivot->SignatureType=='ManagerReplacer'))
                <medium class="for">For :</medium><h1><img src="warehouseinventorycontrol.herokuapp.com/public/ForHerokuOnly/{{$RVMaster[0]->users[4]->Signature}}" alt="signature"></h1>
              @elseif(isset($RVMaster[0]->users[5])&&($RVMaster[0]->users[5]->pivot->Signature=='0')&&($RVMaster[0]->users[5]->pivot->SignatureType=='ManagerReplacer'))
                <medium class="for">For :</medium><h1><img src="warehouseinventorycontrol.herokuapp.com/public/ForHerokuOnly/{{$RVMaster[0]->users[5]->Signature}}" alt="signature"></h1>
              @endif
          ...
          <div class="left-budget">
            ...
            <li>
              @if ($RVMaster[0]->users[2]->pivot->Signature=='0')
                <h1><img src="warehouseinventorycontrol.herokuapp.com/public/ForHerokuOnly/{{$RVMaster[0]->users[2]->Signature}}" alt="signature"></h1>
              @endif
          ...
          <div class="bottom-right-sign bottom">
            ...
            <li>
              @if ($RVMaster[0]->users[3]->pivot->Signature=='0')
                <h1><img src="warehouseinventorycontrol.herokuapp.com/public/ForHerokuOnly/{{$RVMaster[0]->users[3]->Signature}}" alt="signature"></h1>

    ...
    <div class="mct-print-container">
      <div class="title-container">
        <div class="mct-titles">
          <img src="http://warehouseinventorycontrol.herokuapp.com/DesignIMG/logo.png" alt="logo">
            ...
            <div class="issued-name">
              <div class="signature-issued">
                @if ($MCTMast[0]->users[0]->pivot->Signature=='0')
                  <img src="http://warehouseinventorycontrol.herokuapp.com/ForHerokuOnly/{{$MCTMast[0]->users[0]->Signature}}" alt="signature">
                @endif
              </div>
            ...
            <div class="recieve-name">
              <div class="signature-reciever">
                @if ($MCTMast[0]->users[1]->pivot->Signature=='0')
                  <img src="http://warehouseinventorycontrol.herokuapp.com/ForHerokuOnly/{{$MCTMast[0]->users[1]->Signature}}" alt="signature">
                @endif
              </div>

    ...
    <div class="RRbondpaper-Container">
      ...
      <div class="RRMasterDetails">
        <div class="left-details">
          <ul>
            <li><label>Suplier:</label><p>{{$RRconfirmMasterResult[0]->Suplier}}</p></li>
        ...
        <div class="right-details">
          <ul>
            <li><label>B/L-AW/B-W/B-No:</label><p>{{$RRconfirmMasterResult[0]->BNo}}</p></li>
            ...
            <li><label>P.O No.:</label><p>{{$RRconfirmMasterResult[0]->PONo}}</p></li>
          </ul>
        </div>
